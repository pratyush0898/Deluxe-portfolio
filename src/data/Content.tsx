...
const CONTENT = { 
	...
	homepage: {
		...
		description:
			"I am a Web developer skilled in JavaScript and Node.js, building scalable applications and solving problems. Always eager to learn and grow.",
	},
	about: {
		...
		experience: [
			...
			},
			{
				...
				company: "StartupXYZ",
				period: "2018 - 2019",
				description: "Built and maintained client websites while learning best practices for web development."
			}
		]
	},
	articles: {
	...
	support: {
		title: "Your Support Fuels My Passion",
		description:
